...
// EchangesView (20/09, suite du code-splitting -- extraite d'App.jsx dans son
// propre fichier pour pouvoir, elle aussi, passer en lazy) : import "../App"
// depuis ce nouveau fichier (Av/POSTE_REGISTRY) n'est jamais un cycle
// bloquant -- App.jsx est toujours entièrement évalué avant qu'un import()
// dynamique comme celui-ci ne se déclenche (au premier rendu de la vue
// "echanges" seulement), jamais avant.
const EchangesView = lazy(() => import("./components/EchangesView"));
...
// ─── COMPOSANTS DE BASE ───────────────────────────────────────────────────────
export function Av({initials,size=34,famille,color}){
...
export default function App(){
  ...
  {/* Suspense partagé (20/09, code-splitting) : ces 9 vues sont mutuellement
