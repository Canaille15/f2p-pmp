...
const { getPlanning, getAllPublic, setJour, deleteJour, bulkFill, bulkAddCombo, bulkClear, bulkClearUndo } = require('../controllers/planningController');
...
router.post('/:cp/bulk-add-combo',            authMiddleware, bulkAddCombo);
