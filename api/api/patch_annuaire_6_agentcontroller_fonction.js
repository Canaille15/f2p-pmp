// Patch 6 — Annuaire : ajoute le champ auto-éditable "fonction" (agent),
// distinct du grade, self-service comme email/telephone/annuaire_visible.
// Usage : node patch_annuaire_6_agentcontroller_fonction.js
// À exécuter depuis : C:\Users\olive\Desktop\f2p-pmp\api\api
// PRÉREQUIS : avoir déjà exécuté patch_annuaire_2_agentcontroller_visible.js
// PRÉREQUIS SQL : ALTER TABLE agent ADD COLUMN fonction VARCHAR(100) NULL;
//                 (voir migration_annuaire_fonction.sql)
...
content = mustReplaceOnce(content, old1, new1, 'agent-fonction-field');

fs.writeFileSync(FILE, content, 'utf-8');
console.log('OK — agentController.js patché (champ "fonction" auto-éditable ajouté)');
