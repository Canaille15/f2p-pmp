...
// (fins de ligne CRLF exactes, construites explicitement pour éviter tout souci LF/CRLF)
{
  const oldLines = [
  ...
  const r = mustReplaceOnce(content, oldLines, newLines, 'bandeau d\'onglets fixe sur mobile + contraste renforcé');
  content = r.str; ok = ok && r.ok;
}
